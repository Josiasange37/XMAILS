...
('john.doe@example.com', 'contact@xmailo.com', 'Collaboration Proposal', '<h1>Hello</h1><p>I would like to discuss a potential collaboration with XMAILO.</p>', 'Hello, I would like to discuss a potential collaboration with XMAILO.', '[{"filename":"proposal.pdf","content_type":"application/pdf","size":245760}]'),
('sarah@company.com', 'hello@xmailo.com', 'Speaker Confirmation', '<h1>Confirmed</h1><p>I am happy to confirm my participation as a speaker at your upcoming event.</p>', 'I am happy to confirm my participation as a speaker at your upcoming event.', '[{"filename":"speaker_bio.docx","content_type":"application/vnd.openxmlformats-officedocument.wordprocessingml.document","size":51200},{"filename":"photo.jpg","content_type":"image/jpeg","size":1048576}]');
